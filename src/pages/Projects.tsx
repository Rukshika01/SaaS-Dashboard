...
export function Projects() {
  ...
  const save = (project: FlowProject) => setProjects(prev => prev.some(p => p.id === project.id) ? prev.map(p => p.id === project.id ? project : p) : [project, ...prev]);
